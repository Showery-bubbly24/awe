...
export default function WelcomeScreen({ onEnterVideos, onEnterPosts, onLogin, onRegister, onLogout, user }) {
    ...
    <div className="welcome">
      <header className="welcome__header">
        ...
        <div className="welcome__auth-buttons">
          {user ? (
            <>
              <span className="welcome__user-info">
                Добро пожаловать, {user.username} 
                <span className="welcome__user-role">
